                ...
                <div className="space-y-6 border-t border-gray-200 py-6 px-4">
                  ...
                  {categoriesToDisplay?.length <= 0 ? (
                    ...
                    categoriesToDisplay?.map((category) => {
                      return (
                        <>
                          <Link key={category?._id} to={`/products-filters?category=${category?.name}`} className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                            {category?.name}
                          </Link>
                        </>
                      );
                    ...
                    <div className="flex items-center lg:ml-8">
                      ...
                      <div className="flow-root">
                        <Link to="/shopping-cart" className="group -m-2 flex items-center p-2">
                          ...
                          <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">{cartItemsFromLocalStorage?.length > 0 ? cartItemsFromLocalStorage.length : 0}</span>
                        </Link>
                      </div>
                    </div>
                  </div>
